                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async{
                          ...
                          skillList = listUpdate(pokeList[position]);
                          Navigator.push(
                              context, MaterialPageRoute(builder: (context) => MyApp(atState: AttackState(poke: pokeList[position], teraImage: Image.asset('images/not_selected.png'), atSlider: 0, atEffort: 0, atNatPos: 1, atRankPos: 6, atSpCh: pokeList[position].char1, atSp: false, atEffect: '', skill: skillList.first, teraIcon: Image.asset('images/bef_teras.png'), teraType: 'null', stellaFlag: false, stellaEffective: false), dfState: sendDefence, skills: skillList),
                          ));
                        },
                      )
                    ],
